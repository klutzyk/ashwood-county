...
{
    [Export] public float GameMinutesPerSecond{get;set;}=1.5f; public double TotalMinutes{get;private set;}=960; public int Day=>(int)(TotalMinutes/1440)+1;
    ...
    public void SetTotalMinutes(double minutes)=>TotalMinutes=System.Math.Max(0,minutes);
}
