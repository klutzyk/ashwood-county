...
public partial class AuthoringStudioHost:Node
{
    ...
    {
        if(_canvas is null||_roadType is null)return;_canvas.PathType=_roadType.GetItemText(_roadType.Selected);_canvas.PathWidth=(float)_roadWidth.Value;
        _canvas.PathAssetPath=DefaultRoadAsset(_canvas.PathType);
    }
