...
public partial class ContinuousWorldValidation:Node
{
    ...
    public override void _Ready(){if(System.Environment.GetEnvironmentVariable("ASHWOOD_CAPTURE_COUNTY_MAP")=="1"){Callable.From(OpenMap).CallDeferred();SetProcess(false);return;}if(System.Environment.GetEnvironmentVariable("ASHWOOD_VALIDATE_CONTINUOUS_WORLD")!="1"){SetProcess(false);return;}Callable.From(Begin).CallDeferred();}
