...
public static class StartingAreaComposition
{
    ...
    private const string Veg = "res://assets/art/vegetation/";
    ...
    [
        ...
        Plant(Veg + "grass_clump_02.png", 199.0f, 161.6f, .20f),
        Plant(Veg + "flowers_yellow_01.png", 200.4f, 162.2f, .20f),
        Plant(Veg + "bush_dense_02.png", 197.6f, 156.0f, .24f),
        Plant(Veg + "shrub_03.png", 198.4f, 151.8f, .24f),
        Plant(Veg + "fern_02.png", 209.4f, 161.0f, .22f),
        ...
        Prop(Veg + "hedge_01.png", 217.0f, 159.6f, .30f),
        Prop(Veg + "hedge_01.png", 219.4f, 159.8f, .30f),
        Prop(Veg + "hedge_01.png", 221.8f, 159.6f, .30f),
        Prop(Industrial + "abandoned_pickup_01.png", 214.4f, 152.6f, .26f),
        Prop(Roadside + "rusty_barrel_01.png", 224.6f, 152.0f, .20f),
        Plant(Veg + "bush_flowers_02.png", 215.6f, 150.2f, .24f),
        Plant(Veg + "bush_berries_01.png", 224.4f, 156.4f, .24f),
        Plant(Veg + "birch_01.png", 226.0f, 150.6f, .30f),
        Plant(Veg + "deciduous_02.png", 213.6f, 148.6f, .30f),
        ...
        Plant(Veg + "young_pine_02.png", 194.0f, 137.0f, .26f),
        Plant(Veg + "shrub_yellow_01.png", 213.4f, 138.2f, .24f),
        ...
        Plant(Veg + "pine_02.png", 191.0f, 152.0f, .30f),
        Plant(Veg + "pine_02.png", 189.4f, 155.4f, .32f),
        Plant(Veg + "pine_03.png", 192.6f, 157.6f, .26f),
        Plant(OldVeg + "oak_01.png", 187.6f, 150.4f, .26f),
        Plant(Veg + "deciduous_02.png", 190.2f, 148.2f, .30f),
        Plant(Veg + "birch_01.png", 193.8f, 146.4f, .28f),
        Plant(Veg + "young_deciduous_02.png", 194.6f, 150.2f, .24f),
        Plant(Veg + "fern_03.png", 192.0f, 154.4f, .22f),
        Plant(Veg + "fern_02.png", 190.6f, 158.0f, .22f),
        Plant(Veg + "bush_dense_02.png", 194.2f, 158.8f, .24f),
        ...
        Plant(Veg + "pine_02.png", 212.4f, 168.6f, .30f),
        Plant(Veg + "deciduous_02.png", 216.6f, 167.0f, .30f),
        Plant(Veg + "young_pine_02.png", 209.8f, 170.2f, .24f),
        Plant(Veg + "shrub_03.png", 214.2f, 169.4f, .24f),
        ...
        Plant(Veg + "flowers_white_02.png", 208.2f, 150.6f, .20f),
        Plant(Veg + "grass_clump_02.png", 206.6f, 151.4f, .20f)
    ];
